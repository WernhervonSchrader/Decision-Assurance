...
BEGIN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_roles WHERE rolname = 'decision_assurance_metrics_owner') THEN
        CREATE ROLE decision_assurance_metrics_owner NOLOGIN NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT NOBYPASSRLS;
    END IF;
END
$roles$;
...
GRANT decision_assurance_metrics_owner TO decision_assurance_migration;
