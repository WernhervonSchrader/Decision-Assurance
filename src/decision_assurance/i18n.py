...
TRANSLATIONS = {
    "en": {
        ...
        "PILOT_EXPORT_UNAVAILABLE": "The signed export is temporarily unavailable.",
    ...
    "de": {
        ...
        "PILOT_EXPORT_UNAVAILABLE": "Der signierte Export ist vorÃ¼bergehend nicht verfÃ¼gbar.",
