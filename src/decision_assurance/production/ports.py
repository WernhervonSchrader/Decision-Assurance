...
class JobRepositoryPort(Protocol):
    ...
    def claim(self, worker_id: str, *, now: str) -> ResearchJob | None: ...
    def heartbeat(self, job_id: str, lease_token: str, *, now: str) -> None: ...
    def complete(self, job_id: str, lease_token: str, *, partial: bool, now: str) -> None: ...
    def fail(self, job_id: str, lease_token: str, reason_code: str, *, now: str) -> None: ...
